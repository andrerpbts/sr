...
class SetupsControllerTest < ActionController::TestCase
  ...
  test "should create setup" do
    assert_difference('Setup.count') do
      post :create, setup: { max_banner_image: @setup.max_banner_image, max_vehicle_image: @setup.max_vehicle_image }
    end
  ...
  test "should update setup" do
    put :update, id: @setup, setup: { max_banner_image: @setup.max_banner_image, max_vehicle_image: @setup.max_vehicle_image }
    assert_redirected_to setup_path(assigns(:setup))
  end
