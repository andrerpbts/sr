...
class BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { banner: @banner.banner, height: @banner.height, left: @banner.left, top: @banner.top, type: @banner.type, width: @banner.width }
    end
  ...
  test "should update banner" do
    put :update, id: @banner, banner: { banner: @banner.banner, height: @banner.height, left: @banner.left, top: @banner.top, type: @banner.type, width: @banner.width }
    assert_redirected_to banner_path(assigns(:banner))
  end
